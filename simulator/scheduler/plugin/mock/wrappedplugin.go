...
// Source: github.com/kubernetes-sigs/kube-scheduler-simulator/scheduler/plugin (interfaces: Store,FilterPluginExtender,ScorePluginExtender,NormalizeScorePluginExtender)
