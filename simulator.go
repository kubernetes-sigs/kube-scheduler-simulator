...
func startSimulator() error {
	...
	restclientCfg, apiShutdown, err := k8sapiserver.StartAPIServer(cfg.KubeAPIServerURL, cfg.EtcdURL, cfg.CorsAllowedOriginList, cfg.KubeAPIServerCertPath, cfg.KubeAPIServerKeyPath)
	if err != nil {
