...
func createAggregatorConfig(kubeAPIServerConfig genericapiserver.Config, etcdOptions genericoptions.EtcdOptions, externalInformers kubeexternalinformers.SharedInformerFactory) (*aggregatorapiserver.Config, error) {
	...
	if err := apiOpts.ApplyTo(&genericConfig, aggregatorapiserver.DefaultAPIResourceConfigSource(), aggregatorscheme.Scheme); err != nil {
		return nil, err
	}
...
func makeAPIServiceAvailableHealthCheck(name string, apiServices []*v1.APIService, apiServiceInformer informers.APIServiceInformer) healthz.HealthChecker {
	...
	apiServiceInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc:    func(obj interface{}) { handleAPIServiceChange(obj.(*v1.APIService)) },      //nolint:forcetypeassert
		UpdateFunc: func(old, new interface{}) { handleAPIServiceChange(new.(*v1.APIService)) }, //nolint:forcetypeassert,predeclared
	})
