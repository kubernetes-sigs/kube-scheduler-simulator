...
func (h *ExportHandler) Export(c echo.Context) error {
	...
	rs, err := h.service.Export(ctx, h.service.WithIgnoreErr(false))
	if err != nil {
...
func (h *ExportHandler) Import(c echo.Context) error {
	...
	err := h.service.Import(ctx, convertToResourcesApplyConfiguration(reqResources), h.service.WithIgnoreErr(false))
	if err != nil {
